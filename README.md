...
- [Paw](https://paw.cloud) - API & HTTP client (Paid: €50)
...
- [Things](https://culturedcode.com/things/) - Best task manager in the world ($50 for Mac + $10 for iPhone).
...
- [FMail](https://arievanboxel.fr/fmail/en/) - unofficial desktop app for FastMail.
- [Reeder](https://reederapp.com) - The best RSS reader for Apple devices (Paid: $10).s
...
- [Swish](https://highlyopinionated.co/swish/) - has brilliant gestures to throw windows left & right. Nicely supplements any other window manager (Paid €12).
...
- [One Dark Pro](https://marketplace.visualstudio.com/items?itemName=zhuangtongfa.Material-theme) - second best theme for VSCode (still requires some tweaking).
...
- [PHP Intelephense](https://marketplace.visualstudio.com/items?itemName=bmewburn.vscode-intelephense-client) - better PHP support.
